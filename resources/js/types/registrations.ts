...
export interface Registration { id: number; race_id: number; participant: Participant; race: Race; category: Category; notes: string; _originalParticipantName: string; _originalNotes: string; }
